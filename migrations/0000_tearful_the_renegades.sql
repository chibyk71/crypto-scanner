...
CREATE INDEX `idx_sim_label` ON `simulated_trades` (`label`);
...
CREATE INDEX `idx_symbol_history_excursions` ON `symbol_history` (`avg_mae`,`avg_mfe`);
CREATE INDEX `idx_trades_symbol` ON `trades` (`symbol`);
CREATE INDEX `idx_trades_timestamp` ON `trades` (`timestamp`);
CREATE INDEX `idx_training_symbol` ON `training_samples` (`symbol`);
CREATE INDEX `idx_training_label` ON `training_samples` (`label`);
